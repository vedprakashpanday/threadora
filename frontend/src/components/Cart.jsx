    ...
    <div className="container">
            ...
            <div className="col-md-12">
                ...
                <table className='table'>
                    <tbody>
                        ...
                        <td valign='middle'>
                            <input type="number" style={{width:'100px'}} name="quantity" id="quantity" value={1}  className='form-control'/>
                        </td>
                        <td valign='middle'>
                            <svg xmlns="http://www.w3.org/2000/svg" width="45" height="45" fill="currentColor" className="bi bi-trash3" viewBox="0 0 16 16">
        ...
        <div className="row justify-content-end pb-5">
            ...
            <div className="d-flex justify-content-end ">
                <button className="btn btn-outline-primary my-3 ">Proceed To CheckOut</button>
            </div>
            </div>
        </div>
    </div>
